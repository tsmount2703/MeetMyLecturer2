<%-- 
    Document   : login
    Created on : Oct 9, 2023, 9:35:34 PM
    Author     : Dell
--%>
            ...
            <div class="row justify-content-center mt-5">
                <div class="col-md-6">
                    <div class="card shadow-lg p-4 border">
                        <div class="card-body">
                            <h3 class="text-center">MEETING MY LECTURER</h3>
                            <form action="<c:url value="/users/login_handler.do" />" method="post">
                                <div class="form-group">
                                    <div class="input-group input-group-lg">
                                        <span class="input-group-text"><i class="bi bi-person-fill"></i></span>
                                        <input required type="text" class="form-control form-control-lg " id="userEmail" name="userEmail" placeholder="Enter your email">
                                    </div></div>
