<%-- 
    Document   : create
    Created on : Oct 25, 2023, 1:02:12 PM
    Author     : Dell
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container mt-5">
            <h2 style="display: flex; justify-content: center">Free Slots Creation</h2>
            <form action="<c:url value="/freeSlots/create_handler.do"/>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" id="lecturerID" placeholder="Lecturer ID" name="lecturerID"  value="${users.userID}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <label for="password" class="col-md-2 col-form-label"><strong>Password:</strong></label>
                    <div class="col-md-10">
                        <input type="text" class="form-control" id="password" placeholder="Password" name="password">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="capacity" class="col-md-2 col-form-label"><strong>Capacity:</strong></label>
                    <div class="col-md-10">
                        <input type="number" step="1" class="form-control" id="capacity" placeholder="Capacity" name="capacity">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="meetLink" class="col-md-2 col-form-label"><strong>Meet Link:</strong></label>
                    <div class="col-md-10">
                        <input type="text" class="form-control" id="meetLink" placeholder="Meet Link" name="meetLink">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="count" class="col-md-2 col-form-label"><strong>Count:</strong></label>
                    <div class="col-md-10">
                        <input type="number"  step="1" class="form-control" id="count" placeholder="Count" name="count">
                    </div>
                </div>
                <div class="form-group row">
