<%-- 
    Document   : update
    Created on : Oct 24, 2023, 11:36:39 PM
    Author     : Dell
--%>
        ...
        <div class="container mt-5">
            <form action="<c:url value="/requests/update_handler.do"/>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="subjectCode" name="subjectCode" value="${requests.subjectCode}">
                    <!--<input type="hidden" name="subjectCode" value="${requests.subjectCode}">-->
                </div>

                <div class="form-group">
                    <label for="studentID"> Student ID:</label>
                    <input type="text" class="form-control" id="studentID" name="studentID" value="${requests.studentID}">
                    <!--<input type="hidden" name="studentID" value="${requests.studentID}">-->
                </div>

                <div class="form-group">
                    <label for="lecturerID"> Lecturer ID:</label>
                    <input  type="text" class="form-control" id="lecturerID" name="lecturerID" value="${requests.lecturerID}">
...
<!--                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="description"  name="description" value="${requests.description}">
